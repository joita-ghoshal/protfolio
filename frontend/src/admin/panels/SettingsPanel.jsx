    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="space-y-6">
      <div className="admin-card p-8 md:p-10">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-14 h-14 rounded-2xl bg-[#00E5FF]/10 flex items-center justify-center"><FiSettings className="w-7 h-7 text-[#00E5FF]" /></div>
          <div><h2 className="text-2xl font-bold text-white">Settings</h2><p className="text-[#94A3B8] text-sm">Configure your site settings</p></div>
        </div>
        ...
        {!settings ? (
          <div className="border-t border-border pt-8 text-center py-12">
            ...
            <p className="text-[#94A3B8] text-lg font-medium">No settings found</p>
            <p className="text-[#94A3B8] text-sm mt-1">Please add a settings record via the database</p>
          </div>
        ) : (
          <div className="border-t border-border pt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-white mb-1.5">Site Title</label>
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-white mb-1.5">Meta Description</label>
                <textarea name="meta_description" rows={2} value={form.meta_description} onChange={handleChange} className="input-field" />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-white mb-1.5">Meta Keywords</label>
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-1.5">Theme Color</label>
                <div className="flex items-center gap-3">
                  <input type="color" name="theme_color" value={form.theme_color} onChange={handleChange} className="w-10 h-10 rounded-lg border border-white/[0.06] cursor-pointer" />
                  <span className="text-sm text-[#94A3B8]">{form.theme_color}</span>
                </div>
              </div>
            </div>
